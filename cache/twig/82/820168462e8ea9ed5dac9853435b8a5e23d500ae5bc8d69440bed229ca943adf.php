...
class __TwigTemplate_e6efa58cc1e86f8c811c19fef177e08c9429582eb29bc947446533fd5bb80428 extends Twig_Template
{
    ...
    <div class=\"mobile-container\">
        <div class=\"overlay\" id=\"overlay\">
            <div class=\"mobile-logo\">
                ";
        // line 98
        $this->loadTemplate("@images/logo.svg", "partials/base.html.twig", 98)->display($context);
        // line 99
        echo "            </div>
...
";
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        $this->loadTemplate("@images/logo.svg", "partials/base.html.twig", 44)->display($context);
        echo "</a>
                    </section>
    ...
    {% block header %}
        <section id=\"header\" class=\"section\">
            <section class=\"container {{ grid_size }}\">
                <nav class=\"navbar\">
                    <section class=\"navbar-section logo\">
                        <a href=\"{{ home_url }}\" class=\"navbar-brand mr-10\">{% include('@images/logo.svg') %}</a>
                    </section>
                    <section class=\"navbar-section\">
